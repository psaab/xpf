...
- **Timestamp**: 2026-06-19
  - **Action**: /research #2033 — drafted plan.md r1 for RA goodbye-vs-normal-RA serialization race
  - **File(s)**: docs/research/2033-ra-withdraw-serialize/plan.md

- **Timestamp**: 2026-06-19
  - **Action**: /research #2033 — plan.md revised to r2 (folded Codex+AGY+SMR round-1 NEEDS-REVISION: W2 window correction, W3 ordering-not-race, single-channel+mode shutdown, interruptible burst, WithdrawOnce claim+no-link-toggle, conn-level test seam)
  - **File(s)**: docs/research/2033-ra-withdraw-serialize/plan.md

- **Timestamp**: 2026-06-19
  - **Action**: /research #2033 — plan.md revised to r3 (folded Codex r2: invariant=goodbye-is-last not no-RA-after-withdraw; WithdrawOnce claim must make Apply WAIT not skip; conn.Close-after-join graceful-only, before-join for hard. Found I13: demotion Withdraw races config-apply Clear w/o applySem -> graceful-upgrades-hard)
  - **File(s)**: docs/research/2033-ra-withdraw-serialize/plan.md
