...
pub(crate) fn run() -> Result<(), String> {
    ...
    let state = Arc::new(Mutex::new(ServerState {
        status: ProcessStatus {
            ...
            ipsec_sa_miss_dropped_packets_total: 0,
            ipsec_sa_miss_no_sa_total: 0,
            ipsec_sa_miss_truncated_total: 0,
            ipsec_sa_miss_malformed_ike_total: 0,
            ipsec_sa_miss_keepalive_total: 0,
            ipsec_sa_snapshot_stale_deny_total: 0,
            ipsec_sa_inserts_total: 0,
