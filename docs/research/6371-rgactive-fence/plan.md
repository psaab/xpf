...
- **Revision:** r8 — after Codex r1-r7 + Claude SMR r1-r7, all firsthand-verified.
...
terminated**. This is a **detected-but-unfixed residual whose acceptance is
CONDITIONAL and not yet granted** (see the deferral prerequisites below), disclosed
...
is a disclosed detected-but-unfixed residual whose acceptance is conditional (§5.4); deferral of the map-as-authority
