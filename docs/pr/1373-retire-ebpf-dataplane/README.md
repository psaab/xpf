...
| #1379 dataplane events | [plan-1379-dataplane-events.md](plan-1379-dataplane-events.md) | #1373 Phase 4 | Policy-deny, screen-drop, PBR filter logs, non-PBR input/output/lo0 filter logs, source-disambiguated FILTER_LOG syslog, and deterministic fanout coverage landed; live cluster evidence remains if Phase 4 requires operator artifacts |
