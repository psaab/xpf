...
- **CLI history:** Readline can load existing `~/.xpf_history` and `~/.xpf_cli_history` files, but automatic saving of submitted lines is disabled because commands may contain credentials
