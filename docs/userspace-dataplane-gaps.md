...
- **WireGuard (#5618)** is adjudicated on the **dataplane path** since #8274,
  and is not adjudicated on the **kernel path** — a residual #8274 stated rather
  than closed, which #9594 found is also reachable on covered ingress.
