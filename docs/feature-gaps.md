...
| **DHCPv6 Relay** | `forwarding-options dhcp-relay dhcpv6 ...` | RFC 8415 Relay-Forw / Relay-Reply relay agent | Medium | Not implemented — `pkg/dhcprelay` relays DHCPv4 only. The stanza is REFUSED at commit, warned on the tolerant load / peer-sync path, and never compiled as the DHCPv4 relay (#9411) |
