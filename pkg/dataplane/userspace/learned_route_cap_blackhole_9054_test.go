...
func TestProtocolVersionMovedWithTheWire9054(t *testing.T) {
	...
	// later bump (#9425 took it to 11, #9546 to 12, #9412 to 13, #9521 to 14, #9520 to 15, #9714 to 16, #9587 to 17) because what it asserts is that the two
	// planes moved TOGETHER — a one-sided bump makes every pairing a mismatch.
	if !strings.Contains(string(raw), "= 17;") {
