		...
		Bindings: []userspace.BindingStatus{
			{
				...
				RouteMissPackets: 2, UMEMSliceDropped: 1, UnknownVLANDropped: 2, DstMACDropped: 3,
				MartianDropped: 1, IPv6ExtHeaderDropped: 4, NeighborMissPackets: 1, ExceptionPackets: 3,
