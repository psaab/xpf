...
var allowedFunctions = map[string]string{
	...
	"daemon::CloseKernelTransitForCleanup":   "procfs transit closure before standalone cleanup (#9725)",
	"daemon::applyHostForwardingPosture":     "procfs host forwarding posture (#9725)",
