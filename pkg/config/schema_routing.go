...
var schemaRoutingInstances = &schemaNode{desc: "Routing instance configuration", // #9323: the admissible children of `routing-instances <name>` are gated by
	...
	wildcard: &schemaNode{desc: "Routing instance name", placeholder: "<instance-name>", children: map[string]*schemaNode{
		...
		"description":         {desc: "Routing instance description", args: 1, nodeValidator: validateRoutingInstanceDescriptionNode9736, placeholder: "<text>", children: nil},
		"vrf-target":          {desc: "VRF route target (accepted; xpf compiles no BGP/MPLS VPN state from it)", args: 1, nodeValidator: validateRoutingInstanceVRFTargetNode9736, placeholder: "<target>", children: nil},
		"vrf-table-label":     {desc: "VRF table label (accepted; xpf compiles no BGP/MPLS VPN state from it)", nodeValidator: validateRoutingInstanceFlagNode9736, children: nil},
		"route-distinguisher": {desc: "VRF route distinguisher (accepted; xpf compiles no BGP/MPLS VPN state from it)", args: 1, nodeValidator: validateRoutingInstanceRouteDistinguisherNode9736, placeholder: "<rd>", children: nil},
